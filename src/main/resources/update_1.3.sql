...
BEGIN
    ...
    FOR sr IN SELECT * FROM sign_request
        ...
        LOOP
            ...
            insert into sign_book values (sb, null, sr.create_date, null, null, null, null, false, concat('Signature_simple_', sr.title, '_', sr.id), sr.status, null, null, null, null, 1, sr.create_by_id, lw, null, lw);
