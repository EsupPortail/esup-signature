    ...
    initSignFields() {
        for(let i = 0; i < this.currentSignRequestParamses.length; i++) {
            ...
            if (this.mode === "sign" && this.signable) {
                ...
                signSpaceDiv.css("width", Math.round(currentSignRequestParams.signWidth / .75 * this.pdfViewer.scale * this.getBrowserZoom()) + "px");
                signSpaceDiv.css("height", Math.round(currentSignRequestParams.signHeight /.75 * this.pdfViewer.scale * this.getBrowserZoom()) + "px");
                ...
                if (this.mode === 'comment') {
                    ...
                    if(signDiv != null) {
                        if(signDiv.attr('data-es-width') !== undefined && signDiv.attr('data-es-height') !== undefined) {
                            ...
                            spotDiv.css("width", signDiv.attr('data-es-width') / .75 * this.pdfViewer.scale * this.getBrowserZoom());
                            spotDiv.css("height", signDiv.attr('data-es-height') / .75 * this.pdfViewer.scale * this.getBrowserZoom());
                        }
                        signDiv.css("width", Math.round(spot.signWidth / .75 * self.pdfViewer.scale * this.getBrowserZoom()) + "px");
                        signDiv.css("height", Math.round(spot.signHeight / .75 * self.pdfViewer.scale * this.getBrowserZoom()) + "px");
