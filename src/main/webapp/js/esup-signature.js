...
document.addEventListener('DOMContentLoaded', function() {
	...
	vanillaUpload = document.querySelector('.vanilla-upload');
	  ...
	  document.getElementById('vanilla-demo').addEventListener('update', function(ev) { vanilla.result('canvas').then(saveVanilla); });
	...
	function readFile(input) {
            ...
            reader.onload = function (e) {
            	document.getElementById('vanilla-demo').classList.add('good');
            	vanilla.bind({
            	    url: e.target.result,
            	    orientation: 1
            	  });
