...
@Configuration
@PropertySources({@PropertySource("classpath:META-INF/spring/database.properties"), @PropertySource("classpath:META-INF/spring/fs.properties"), @PropertySource("classpath:META-INF/spring/mail.properties"), @PropertySource("classpath:META-INF/spring/security.properties"), @PropertySource("classpath:META-INF/spring/dss.properties")})
