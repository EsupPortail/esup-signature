...
public class TagLogController {
    ...
    public String list(
        ...
        List<TagLog> taglogs = TagLog.findTagLogs(annee, dateFilter, searchString, page, size, sortFieldName, sortOrder).getResultList();

        float nrOfPages = (float) TagLog.countFindTagLogs(annee, dateFilter, searchString) / sizeNo;
