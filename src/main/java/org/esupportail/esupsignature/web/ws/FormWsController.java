...
public class FormWsController {
    ...
    public Long start(@PathVariable Long id,
        ...
        try {
            ...
            SignBook signBook = signBookService.sendForSign(data.getId(), recipientEmails, allSignToCompletes, null, targetEmails, targetUrls, eppn, eppn, true, datas, null);
    ...
    public Long startWithDoc(@PathVariable Long id,
        ...
        try {
            ...
            SignBook signBook = signBookService.sendForSign(data.getId(), recipientEmails, allSignToCompletes, null, targetEmails, targetUrls, createByEppn, createByEppn, true, datas, multipartFiles[0].getInputStream());
            return signBook.getSignRequests().get(0).getId();
