...
public class ExceptionHandlerControllerAdvice {
    ...
    public String handleMaxSizeException(RedirectAttributes redirectAttributes,
        ...
        redirectAttributes.addFlashAttribute("message", new UiMessageDto("error", "Fichier trop volumineux. Taille supérieure à " + FileUtils.byteCountToDisplaySize(globalProperties.getMaxUploadSize())));
    ...
    public void handleClientAbort(ClientAbortException ex) {
        logger.debug("Client a interrompu la requête : {}", ex.getMessage());
    }

    @ExceptionHandler(AsyncRequestNotUsableException.class)
    public void handleAsyncRequestNotUsable(AsyncRequestNotUsableException ex) {
        logger.debug("Requête async interrompue par le client : {}", ex.getMessage());
    }
