...
privileged aspect SignRequest_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> SignRequest.fieldNames4OrderClauseFilter = java.util.Arrays.asList("log", "name", "createDate", "createBy", "updateDate", "updateBy", "recipientEmail", "description", "originalFile", "signedFile", "status", "params", "signBookId", "signBookName", "signType", "newPageType", "signPageNumber", "xPos", "yPos");
