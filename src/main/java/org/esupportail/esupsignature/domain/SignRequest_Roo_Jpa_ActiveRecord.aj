...
privileged aspect SignRequest_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> SignRequest.fieldNames4OrderClauseFilter = java.util.Arrays.asList("log", "name", "title", "createDate", "createBy", "description", "originalDocuments", "documents", "overloadSignBookParams", "signRequestParams", "status", "signBooks", "allSignToComplete");
