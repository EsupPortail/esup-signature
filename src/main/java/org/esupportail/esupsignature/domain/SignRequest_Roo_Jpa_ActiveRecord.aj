...
privileged aspect SignRequest_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> SignRequest.fieldNames4OrderClauseFilter = java.util.Arrays.asList("name", "createDate", "createBy", "updateDate", "updateBy", "description", "originalFile", "signedFile", "status", "params", "signType", "newPageType", "signPageNumber", "xPos", "yPos");
