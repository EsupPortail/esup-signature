...
public class FrontendGlobalPropertiesDto {
    ...
    public FrontendGlobalPropertiesDto() {
    }

    public static FrontendGlobalPropertiesDto fromGlobalProperties(GlobalProperties props) {
        FrontendGlobalPropertiesDto dto = new FrontendGlobalPropertiesDto();
