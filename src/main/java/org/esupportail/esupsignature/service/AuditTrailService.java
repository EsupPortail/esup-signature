...
public class AuditTrailService {
    ...
    public AuditStep createAuditStep(String userEppn, String signId, String timeStampId, String certificat, String timeStampCertificat, Date timeStampDate, Boolean allScrolled, Integer page, Integer posX, Integer posY) {
        ...
        if(authentication != null) {
            ...
            authenticationDetails.put("type", authentication.getClass().getName());
            authenticationDetails.put("registration", authentication.getClass().getSimpleName());
            if(authentication instanceof OAuth2AuthenticationToken oAuth2AuthenticationToken) {
                authenticationDetails.put("registration", oAuth2AuthenticationToken.getAuthorizedClientRegistrationId());
                if(oAuth2AuthenticationToken.getPrincipal() instanceof DefaultOidcUser) {
                    authenticationDetails.put("credential", ((DefaultOidcUser) oAuth2AuthenticationToken.getPrincipal()).getIdToken().getTokenValue());
                }
            }
        }
