...
public class OVHSmsService implements SmsService {
    ...
    public void sendSms(String phoneNumber, String message) throws EsupSignatureRuntimeException {
        ...
        try {
            ...
            String BODY   = "{\"receivers\":[\"" + phoneNumber + "\"],\"message\":\""+ message + "\",\"priority\":\"high\",\"senderForResponse\":" + smsProperties.getSenderForResponse() + ",\"sender\":\""+smsProperties.getUsername()+"\",\"noStopClause\":" + smsProperties.getSenderForResponse() + "}";
